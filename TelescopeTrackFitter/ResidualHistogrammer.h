...
public:
	...
	struct PlaneHistograms {
		...
		PlaneHistograms(const TelescopeConfiguration& det) :
			xResidual( ("xResidual_"+std::to_string(n)).c_str(), ("xResidual_"+std::to_string(n)).c_str(), 100, -0.1, 0.1),
			yResidual( ("yResidual_"+std::to_string(n)).c_str(), ("yResidual_"+std::to_string(n)).c_str(), 100, -0.1, 0.1),
			zRotation( ("zRotation_"+std::to_string(n)).c_str(), ("zRotation_"+std::to_string(n)).c_str(), 100, -0.025, 0.025),
...
public:
	TrackHistogrammer(std::string name="");
